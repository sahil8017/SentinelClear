    ...
    <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 ease-out">
      <div>
        ...
        <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-2 max-w-lg">
          Inject systemic faults, database partitions, and high-latency spikes to validate the resilience and auto-recovery capabilities.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 shadow-sm flex flex-col h-[500px]">
